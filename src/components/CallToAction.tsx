          ...
          <div className="relative z-10 flex flex-col xl:flex-row items-center justify-between gap-10">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full xl:w-auto">
              ...
              <a
                ...
                className="w-full sm:w-auto inline-block text-center px-8 py-3 bg-[#111] hover:bg-[#222] border border-gray-700 text-white rounded-lg font-medium transition-colors cursor-pointer"
              >
                View Docs
              </a>
              <a
